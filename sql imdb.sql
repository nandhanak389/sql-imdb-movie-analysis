...
select m.id,m.name,m.year,m.rankscore from movies m 
...
select  d.id,d.first_name,d.last_name, avg(m.rankscore) as avg_rankscore
 from directors d 
...
select d. first_name,d.last_name ,count(dg.genre) from directors d
